...
export default function TargetUserBar() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE}/events-by-user`);
      ...
      <div className="bg-gradient-to-br from-white to-gray-50 p-6 rounded-2xl shadow-lg border border-gray-100">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600">
            Users with highest event activity
          </p>
        </div>
        ...
        {loading ? (
          ...
          >
            ...
            <YAxis type="category" dataKey="user" tick={{ fontSize: 12, fill: '#6b7280' }} width={60} />
            <Tooltip
              contentStyle={{
                borderRadius: '8px',
                fontSize: '13px',
