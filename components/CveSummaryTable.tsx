    ...
    <div className="bg-white rounded-lg shadow p-6 border">
      ...
      <div className="mb-4 flex justify-between items-center gap-4">
        ...
        <select
          ...
          className="border px-3 py-2 rounded-lg bg-white text-gray-700 cursor-pointer focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 text-sm min-w-[140px]"
        >
          <option value="All">All Severities</option>
